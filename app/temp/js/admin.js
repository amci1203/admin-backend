...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventCalendar = __webpack_require__(3);

	var _EventCalendar2 = _interopRequireDefault(_EventCalendar);

	var _MobileMenu = __webpack_require__(125);
	...
	var _StickyHeader = __webpack_require__(131);

	var _StickyHeader2 = _interopRequireDefault(_StickyHeader);

	var _FullScreenSection = __webpack_require__(132);

	var _FullScreenSection2 = _interopRequireDefault(_FullScreenSection);

	var _SocialMediaButtons = __webpack_require__(133);
	...
	function init() {
	    ...
	    handleLogoutButton();
	    (0, _FullScreenSection2.default)('.admin, .admin > *');

	    var nav = (0, _StickyHeader2.default)(),
	...
	function handleLogoutButton() {
	    var logout = (0, _jquery2.default)('.logout');
	    if (logout) {
	        logout.click(function (e) {
	            e.preventDefault;
	            console.log('logging out...');
	            location.replace('http://localhost:3000/logout.php');
	        });
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _string = __webpack_require__(122);

	var _string2 = _interopRequireDefault(_string);

	var _slide = __webpack_require__(123);
	...
	function EventCalendar() {
	    ...
	    function getEventDetails(event) {
	        details.innerHTML = event.target;
	    }
	    ...
	    function getEvents(callback) {
	        (0, _php2.default)('database', 'getEvents', function (data) {
	            ...
	            JSON.parse(data).forEach(function (elm) {
	                ...
	                if (repeats != 'false') {
	                    ...
	                    if (reapeats == 'monthly') {
	                        ...
	                        obj.monthly[day].push(elm);
	                    }

	                    if (repeats == 'annually') {
	                        day = elm.date.substr(5);
	                        if (obj.annually[day]) obj.annually[day] = {};
	                    }
	                    obj[repeats][day][elm.name] = elm;
	                } else {
	                    if (obj.singles[elm.date]) obj.singles[elm.date] = Array();else obj.singles[elm.date].push(elm);
	                }
	            });
	            state.set('events', obj);
	            console.log(obj);
	            if (typeof callback == 'function') callback();
	        });
	    }
	    function postEvent() {
	        var formData = addForm.querySelectorAll('input, select');
	    }
	    ...
	    function showCurrentEvents() {
	        ...
	        var events = state.get('events'),
	            ...
	            annually = events.annually;

	        if (today) {
	            today.forEach(function (event) {
	                html += '\n                    <li class=\'event-list-item no-repeat\'>\n                        <span>' + item.name + '</span>\n                    </li>\n                ';
	            });
	        }

	        //        events.forEach(item => {
	        //            if (item.date == state.get('day') && item.) {
	        //            }
	        //        })
	    ...
	    var state = {},
	        ...
	        if (state.hasOwnProperty(prop)) {
	            if (isValidValue(state[prop], val)) {
	                ...
	                return;
	            } else throw new Error('value does not satisfy the property\'s type constraint');
	        } else throw new Error('property "' + prop + '" does not exist');
	    };

	    for (var prop in initialState) {
	        var parent = initialState,
	            _this = {};

	        if (parent[prop].default && !isValidValue(parent[prop], parent[prop].default)) {
	            throw new Error('default value is not of type "' + parent[prop].type + '"');
	        }

	        _this.value = parent[prop].default ? parent[prop].default : null;
	        _this.type = parent[prop].type ? parent[prop].type : 'any';
...
/***/ function(module, exports, __webpack_require__) {
	...
	function MobileMenu() {
	    ...
	    return function () {
	        ...
	        return { toggleMenu: toggleMenu, closeMenu: closeMenu };
	    }();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  }, e.isObject = o, e.isObjectLike = r, e.isSymbol = i, e.now = t, e.toNumber = u, e.VERSION = "4.17.1", "function" == "function" && _typeof(__webpack_require__(127)) == "object" && __webpack_require__(127) ? (d._ = e, !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return e;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jquerySmoothScroll = __webpack_require__(129);

	var _jquerySmoothScroll2 = _interopRequireDefault(_jquerySmoothScroll);

	var _noframework = __webpack_require__(130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function StickyHeader(_disappears) {
	    var nav = document.getElementById('primary-nav'),
	        heading = nav.querySelector('.primary-nav__heading'),
	        trigger = nav,
	        interval = 200,
	    ...
	    return function () {
	        ...
	        if (disappears) {
	            window.addEventListener('scroll', _lodash2.default.throttle(handleScroll, interval));
	        }

	        return { setHeading: setHeading };
	    }();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SocialMediaButtons() {
	    var smButtons = (0, _jquery2.default)('#social-media-buttons'),
	        smToggles = (0, _jquery2.default)('.social-media-toggle');
	    ...
	    return function () {
	        ...
	        return { toggleSocialMediaButtons: toggleSocialMediaButtons };
	    }();
	}
