...
/***/ function(module, exports, __webpack_require__) {
	...
	var _php = __webpack_require__(2);
	...
	var _AdminPanel = __webpack_require__(6);

	var _AdminPanel2 = _interopRequireDefault(_AdminPanel);

	var _FullScreenSection = __webpack_require__(7);

	var _FullScreenSection2 = _interopRequireDefault(_FullScreenSection);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _jquery2.default)(document).ready(_Injector2.default.bind(window, 'sections', 'html', init));

	function init() {

	    (0, _AdminPanel2.default)();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function php(file, func, args, cb) {
	      var path = 'http://' + location.host + '/api.php',
	          argsLen = arguments.length,
	          post = argsLen == 4 ? { file: file, func: func, args: args } : { file: file, func: func },
	          callback = [].concat(Array.prototype.slice.call(arguments))[argsLen - 1];

	      _jquery2.default.post(path, post).done(function (data) {
...
/***/ function(module, exports) {
	...
	*/
	...
	function State(initialState) {
	    var state = {},
	        fireEvent = function fireEvent(prop) {
	        var event = new CustomEvent('state', { state: prop });
	        document.dispatchEvent(event);
	    },
	        isValidValue = function isValidValue(prop, val) {
	        if ((typeof val === 'undefined' ? 'undefined' : _typeof(val)) == prop.type) return true;else if (prop.type == 'any') return true;else if (prop.type == 'array' && Array.isArray(val)) return true;else return false;
	    },
	    ...
	    var _loop = function _loop(prop) {
	        ...
	        var allowed = _init[prop].allowed;
	        if (allowed) {
	            var allValid = true;
	            allowed.forEach(function (item) {
	                if ((typeof item === 'undefined' ? 'undefined' : _typeof(item)) != _this.type) {
	    ...
	    return function () {
	        return { get: get, set: set, isValidValue: isValidValue };
	    }();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Injector(rootFolder, defaultExt, callback) {
	    function findView(elm) {
	        ...
	        if (path.charAt(0) == '/') {
	            var abs = path.substr(path.lastIndexOf('.')) == ext ? path : path + '.' + ext;
	            return abs;
	        };
	    ...
	    function get(elm, path, isLast) {
	        _jquery2.default.get(path).fail(function (jqXHR, text) {
	            return jqXHR.status == 404 ? (0, _jquery2.default)(elm).remove() : console.error(text);
	        }).done(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Slides(_selector, _affectedBy, _loops) {
	    var affectedBy = affectedBy,
	        loops = loops || false,
	        selector = _selector.trim(),
	        container = (0, _jquery2.default)(selector),
	    ...
	    function initSlides() {
	        ...
	        slides.each(function (index) {
	            return classList.add('slide-' + index);
	        });
	    }
	    ...
	    function slide(slideTo) {
	        ...
	        var nextSlide = currentSlide == numSlides - 1 ? 0 : currentSlide + 1,
	    ...
	    function slideToPrevious() {
	        toggleSlides(previousSlide);
	    }

	    function jump(toSlide) {
	        var targetSlide = toSlide ? +toSlide : +event.target.dataset.jump;
	    ...
	    function toggleSlides(showIndex) {
	        ...
	        setTimeout(function () {
	            return slides.eq(currentSlide).css('display', 'none');
	        }, 250);

	        slides.eq(showIndex).css('display', 'block');
	        setTimeout(function () {
	            return slides.eq(showIndex).addClass('slide--open');
	        }, 250);

	        previousSlide = currentSlide;
	        currentSlide = showIndex;

	        (0, _jquery2.default)(document).trigger('slide', [null, null]);
	        if (container.hasClass('scroll-top')) (0, _jquery2.default)(window).scrollTop(0);
	    }

	    function handleModalClose(event, isAffected) {
	        wait(500);
	        if (isAffected === affectedBy) {
	            slides.eq(currentSlide).removeClass('slide--open').css('display', 'none');
	            slides.eq(0).addClass('slide--open').css('display', 'block');
	            currentSlide = 0;
	        }
	    }
	    ...
	    return function () {
	        ...
	        (0, _jquery2.default)(document).on('modal-closed', handleModalClose);

	        return { slide: slide, slideToPrevious: slideToPrevious, jump: jump };
	    }();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventCalendar = __webpack_require__(11);
	...
	function AdminPanel() {
	    var self = document.getElementById('Admin-Panel'),
	        ...
	        [].concat(_toConsumableArray(self.querySelectorAll('.active'))).forEach(function (elm) {
	            return elm.classList.remove('active');
	        });
	        var target = typeof event != 'string' ? event.target.id.replace('section-toggle-', '') : event,
	            pane = document.getElementById(target + '-pane'),
	            content = document.getElementById(target + '-content');

	        [pane, content].forEach(function (elm) {
	    ...
	    return function () {
	        ...
	        (0, _FullScreenSection2.default)(selfId + ', ' + sidebar + ', ' + sidepane + ', ' + content);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function FullScreenSection(selector, breakpoint) {
	    var section = (0, _jquery2.default)(selector.trim());
	    ...
	    function fixHeight() {
	        function shouldApply() {
	            ...
	            var operator = breakpoint.charAt(0),
	        ...
	        if (shouldApply()) section.css('min-height', window.innerHeight);else section.css('min-height', 1);
	    }

	    return function () {
	        fixHeight();
	        (0, _jquery2.default)(window).resize(_lodash2.default.debounce(fixHeight, 200, { leading: false, trailing: true }));

	        return { fixHeight: fixHeight };
	    }();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  }, e.isObject = o, e.isObjectLike = r, e.isSymbol = i, e.now = t, e.toNumber = u, e.VERSION = "4.17.1", "function" == "function" && _typeof(__webpack_require__(10)) == "object" && __webpack_require__(10) ? (d._ = e, !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return e;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slide = __webpack_require__(130);
	...
	function EventCalendar() {
	    ...
	    currentDate = (0, _moment2.default)(),
	        ...
	        firstDayOfYear = (0, _moment2.default)(currentYear + '-01-01').format(shortDateName),


	    // date functions
	    printActiveDay = function printActiveDay() {
	        return (0, _moment2.default)(state.get('day')).format('dddd, MMMM D YYYY');
	    },
	        getDayOfWeek = function getDayOfWeek(day) {
	        return (0, _moment2.default)(day).format(shortDateName);
	    },


	    // event shorthands
	    event = function event(type, elm, func) {
	        return elm.addEventListener(type, func);
	    },
	        click = event.bind(this, 'click'),
	        change = event.bind(this, 'change'),
	        clickEach = function clickEach(list, func) {
	        return [].concat(_toConsumableArray(list)).forEach(function (elm) {
	            return click(elm, func);
	        });
	    },
	    ...
	    function printCalendar(numYears, callback) {
	        ...
	        function printYear(year) {
	            ...
	            for (var i = 0; i < 12; i++) {
	                ...
	                var dayOfWeek = w.indexOf(startFrom) != 6 ? w.indexOf(startFrom) + 1 : 0,
	                ...
	                for (j = 0; j < numDays; j++) {
	                    ...
	                    var monthDigit = String(i + 1).padLeft(2, 0),
	                ...
	                clickEach([].concat(_toConsumableArray(container.querySelectorAll('.calendar__month'))), setActiveDate);
	            }
	        }
	        ...
	        months.push.apply(months, _toConsumableArray(container.querySelectorAll('.calendar__month')));
	    ...
	    function setActiveMonth(direction) {
	        ...
	        if (month == 0 && direction == 'left' || month == 23 && direction == 'right') {
	            ...
	            (0, _slide2.default)(months, state.get('month'), direction, 'slide', function (newIndex) {
	                state.set('month', newIndex);
	                var active = state.get('month');
	    ...
	    function setActiveDate(e) {
	        ...
	        if (target) {
	            if (!(0, _moment2.default)(target.id)._isValid) return false;
	            target.classList.add('active');
	            state.set('day', target.id);
	        } else if (/\d{4}-\d{2}-\d{2}/.test(e) && (0, _moment2.default)(e)._isValid) {
	            document.getElementById(e).classList.add('active');
	            state.set('day', e);
	        } else throw new Error('the string "' + e + '" is not a valid date');

	        // update any views that rely on the active date
	        if (view) [].concat(_toConsumableArray(view)).forEach(function (item) {
	            return item.innerHTML = printActiveDay();
	        });
	        // update any input fields that rely on the active date
	        if (data) [].concat(_toConsumableArray(data)).forEach(function (item) {
	            return item.value = state.get('day');
	        });
	    ...
	    function getEvents(callback) {
	        (0, _php2.default)('database', 'getEvents', function (data) {
	            var arrStart = data.indexOf('['),
	    ...
	    function pushEvents(data, events) {
	        [].concat(_toConsumableArray(data)).forEach(function (elm) {
	            var repeats = elm.repeats,
	                hasEvent = function hasEvent(date) {
	                //                    console.log(date);
	                //                    console.log(repeats);
	                var thisDay = document.getElementById(date);
	            ...
	            switch (repeats) {
	                ...
	                case 'monthly':
	                    ...
	                    startFrom = elm.date.substring(0, 5) == currentYear ? (0, _moment2.default)(elm.date).format('M') : 1;
	                    for (var i = startFrom; i < 12; i++) {
	                        var fStr = currentYear + '-' + String(i).padLeft(2, 0) + '-' + day;
	                ...
	                case 'weekly':
	                    ...
	                    var theseDays = container.querySelectorAll('[data-weekday="${day}"]');
	                    startFrom = Number(elm.date.replaceAll('-', ''));
	                    [].concat(_toConsumableArray(theseDays)).forEach(function (_this) {
	                        var date = Number(_this.id.replaceAll('-', ''));
	    ...
	    function showCurrentEvents() {
	        ...
	        [].concat(_toConsumableArray(eventFeed.children)).forEach(function (elm) {
	            return elm = null;
	        });
	        var html = '';
	        ...
	        var events = state.get('events'),
	            ...
	            listItem = function listItem(type, label, i) {
	            return '<li class=\'event-list-item\' data-index=\'' + type + '-' + i + '\'>' + label + '</li>';
	        };

	        console.log({ today: today, weekly: weekly, monthly: monthly, annually: annually });

	        if (today) today.forEach(function (event, i) {
	            return html += listItem('singles', event.name, i);
	        });
	        if (annually) annually.forEach(function (event, i) {
	            return html += listItem('annually', event.name, i);
	        });
	        if (weekly) weekly.forEach(function (event, i) {
	            return html += listItem('weekly', event.name, i);
	        });
	        if (monthly) monthly.forEach(function (event, i) {
	            return html += listItem('monthly', event.name, i);
	        });

	        eventFeed.innerHTML = html;
	        clickEach([].concat(_toConsumableArray(eventFeed.getElementsByClassName('event-list-item'))), getEventDetails, { capture: true });
	    }
	    ...
	    function getEventDetails(e) {
	        ...
	        switch (type) {
	            ...
	            case 'monthly':
	                nest = (0, _moment2.default)(state.get('day')).format('DD');
	                break;
	        ...
	        var show = nest ? events[type][nest][index] : events.singles[state.get('day')][index];
	    ...
	    return function (callback) {
	        if (container) {
	            ...
	            //funception
	            printCalendar(2, getEvents.bind(_this2, setActiveDate.bind(_this2, state.get('day'))));
	            ;
...
/***/ function(module, exports) {
	...
	String.prototype.maskSubstr = function (startIndex, stopIndex, maskChar) {
	    ...
	    var startAt = startIndex >= 0 ? startIndex : this.length + startIndex,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function slide(_images, currentImage, direction, transition, cb) {
	    var images = _images instanceof _jquery2.default ? _images : (0, _jquery2.default)(_images),
